...
import {deleteproject, getUserProjectApi } from '../service/allApi'
    ...
    <div className=' p-5  shadow-lg'>
        ...
        <div className='p-3 bg-light d-flex align-items-center justify-content-between rounded mt-3'>
            ...
            <div className='d-flex '>
                <Edit project={item}/>
                <Link to={item.github} target='_blank'><FontAwesomeIcon icon={faGithub} size="lg" className='me-4 text-warning' /></Link>
                <Link to={item.website} target='_blank'><FontAwesomeIcon icon={faGlobe} size="lg" className='me-4 text-success' /></Link>
