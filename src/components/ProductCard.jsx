    ...
    return (
        <>
            <Card style={{ width: '100%' }} className='shadow border-0'>
                <Card.Img onClick={handleShow} style={{height:'150px'}} variant="top" src={`${serverUrl}/upload/${project.projectImage}`} />
                <Card.Body>
                    ...
                    <div className='container-fluid'>
                        <div className="row">
                            <div className="col-md-6">
                                <img style={{height:'200px'}} src={`${serverUrl}/upload/${project.projectImage}`} alt="" className='w-100' />
                            </div>
                            <div className="col-md-6">
                                <h3>Description</h3>
                                <p>
